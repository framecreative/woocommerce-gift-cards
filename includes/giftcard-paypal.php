...
function wcgc_add_giftcard_to_paypal($paypal_args)
{
    global $woocommerce;
    ...
    return apply_filters('wcgc_send_giftcard_to_paypal', $paypal_args);
}
add_filter('woocommerce_paypal_args', 'wcgc_add_giftcard_to_paypal');
